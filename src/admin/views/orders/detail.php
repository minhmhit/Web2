        ...
        <form method="POST" action="admin.php?page=orders&action=detail&id=<?= $order['OrderID'] ?>" class="border-t pt-6 mb-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 items-end">
                <div class="md:col-span-2">
                    ...
                    <select name="status" <?= ($hasOrderEditPermission) ? '' : 'disabled' ?> class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition">
                ...
                <button type="submit"
                    <?= $hasOrderEditPermission ? '' : 'disabled' ?>
                    class="w-full md:w-auto px-6 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition <?= !$hasOrderEditPermission ? 'opacity-50 cursor-not-allowed' : '' ?>">
